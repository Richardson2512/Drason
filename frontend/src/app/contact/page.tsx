...
export default function ContactPage() {
 ...
 className="inline-flex items-center gap-2 px-6 py-3 bg-[#1E1E2F] text-white font-medium hover:bg-[#2a2a3f] transition-colors"
 >
 ...
 className="w-full px-4 py-3 border border-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1E1E2F]/20 focus:border-[#1E1E2F] transition-colors"
 />
 </div>
 ...
 options={SUBJECT_OPTIONS.map(opt => ({ value: opt, label: opt }))}
 />
 </div>
 </div>
 ...
 className="w-full px-4 py-3 border border-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1E1E2F]/20 focus:border-[#1E1E2F] transition-colors resize-y"
 />
 </div>
 ...
 type="submit"
 disabled={submitting}
 className="w-full md:w-auto px-8 py-3.5 bg-[#1E1E2F] text-white font-semibold text-base hover:bg-[#2a2a3f] transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
 >
 {submitting ? (
 <>
