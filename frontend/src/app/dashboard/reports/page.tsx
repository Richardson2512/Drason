...
const PLATFORM_OPTIONS = ['smartlead', 'instantly', 'emailbison'];
...
export default function ReportsPage() {
    ...
    return (
        <div className="flex flex-col gap-6">
            {/* Page Header */}
            <div>
                <h1 className="text-[2.25rem] font-bold text-gray-900 tracking-tight">Reports</h1>
                <p className="text-lg text-gray-500 mt-1">Generate and download CSV reports for your data</p>
            </div>
