...
export default function ReleaseNotesPage() {
 ...
 {/* Card */}
 <div className="bg-white p-8 shadow-sm shadow-gray-200/50 border border-gray-100 hover:border-blue-200 transition-colors">
 {/* Version + Date Row */}
 <div className="flex flex-wrap items-center gap-3 mb-3">
 <span className="inline-flex items-center px-3 py-1 bg-blue-600 text-white text-sm font-bold tracking-wide">
 v{release.version}
 </span>
 ...
 className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 transition-colors"
 >
 Contact Us
 </Link>
 </div>
