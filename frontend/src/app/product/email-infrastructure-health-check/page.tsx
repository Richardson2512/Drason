...
export default function ArticlePage() {
    ...
    const jsonLd = {
        ...
        "name": "Superkabe - Email Infrastructure Health Check & Audits",
        "applicationCategory": "BusinessApplication",
        "operatingSystem": "Web",
        "description": "Superkabe enterprise deliverability protection layer for Email Infrastructure Health Check & Audits.",
        "provider": {
            "@type": "Organization",
            "name": "Superkabe",
