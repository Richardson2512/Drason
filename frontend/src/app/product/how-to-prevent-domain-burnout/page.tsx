...
export default function ArticlePage() {
    ...
    const jsonLd = {
        ...
        "name": "Superkabe - How to Prevent Domain Burnout in Cold Email",
        "applicationCategory": "BusinessApplication",
        "operatingSystem": "Web",
        "description": "Superkabe enterprise deliverability protection layer for How to Prevent Domain Burnout in Cold Email.",
        "provider": {
            "@type": "Organization",
            "name": "Superkabe",
