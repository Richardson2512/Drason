...
export default function ArticlePage() {
    ...
    const jsonLd = {
        ...
        "name": "Superkabe - Email Infrastructure Protection Platform",
        "applicationCategory": "BusinessApplication",
        "operatingSystem": "Web",
        "description": "Superkabe enterprise deliverability protection layer for Email Infrastructure Protection Platform.",
        "provider": {
            "@type": "Organization",
            "name": "Superkabe",
