...
export default function ArticlePage() {
    ...
    const jsonLd = {
        ...
        "name": "Superkabe - Case Study: Reducing Bounce Rates by 80%",
        "applicationCategory": "BusinessApplication",
        "operatingSystem": "Web",
        "description": "Superkabe enterprise deliverability protection layer for Case Study: Reducing Bounce Rates by 80%.",
        "provider": {
            "@type": "Organization",
            "name": "Superkabe",
