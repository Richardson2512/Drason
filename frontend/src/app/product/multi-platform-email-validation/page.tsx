...
export default function MultiPlatformEmailValidationPage() {
 ...
 Validate leads once and use them anywhere — send natively from Superkabe, or sync with Smartlead, Instantly, and EmailBison in Protection Mode. One validation layer, one routing history, every sender.
 </p>

 <div className="bg-blue-50/50 border border-blue-100 p-8 mb-12">
 ...
 <p className="text-gray-600 leading-relaxed mb-6">
 The platform adapter handles the translation between Superkabe&apos;s universal lead format and each platform&apos;s specific API requirements. Smartlead expects <code className="text-sm bg-gray-100 px-1 ">company_name</code>. Instantly expects <code className="text-sm bg-gray-100 px-1 ">companyName</code>. EmailBison expects <code className="text-sm bg-gray-100 px-1 ">company</code>. You do not think about any of this. The adapter maps fields automatically.
 </p>
 ...
 <p className="text-gray-600 text-sm"><strong>On the roadmap:</strong> Reply.io is on the platform roadmap but not yet shipped. Until we publish a Reply.io adapter, the integration is unavailable. If you use Reply.io and want to be notified when it lands, <Link href="/contact" className="text-blue-600 hover:text-blue-800 underline">contact us</Link>.</p>
 </div>
 ...
 {/* CTA */}
 <div className="bg-gradient-to-br from-blue-600 to-purple-700 text-white p-8 shadow-xl relative overflow-hidden mt-12">
 ...
 <Link href="/pricing" className="bg-white text-blue-700 font-bold px-6 py-3 hover:bg-blue-50 transition-colors">
 View pricing
 </Link>
 <Link href="/" className="border border-white/30 text-white font-bold px-6 py-3 hover:bg-white/10 transition-colors">
 Start free trial
 </Link>
 </div>
 </div>
 ...
 <Link href="/docs/smartlead-integration" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
 ...
 <Link href="/docs/instantly-integration" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
 ...
 <Link href="/docs/emailbison-integration" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
