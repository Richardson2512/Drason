...
export default function ArticlePage() {
    ...
    const jsonLd = {
        ...
        "name": "Superkabe - Smartlead Deliverability Protection",
        "applicationCategory": "BusinessApplication",
        "operatingSystem": "Web",
        "description": "Superkabe enterprise deliverability protection layer for Smartlead Deliverability Protection.",
        "provider": {
            "@type": "Organization",
            "name": "Superkabe",
