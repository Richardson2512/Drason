...
export default function InfrastructureAssessmentPage() {
 ...
 <td className="px-6 py-4"><span className="px-2 py-1 bg-green-100 text-green-700 text-sm font-bold">EXCELLENT</span></td>
 ...
 <td className="px-6 py-4"><span className="px-2 py-1 bg-blue-100 text-blue-700 text-sm font-bold">GOOD</span></td>
 ...
 <td className="px-6 py-4"><span className="px-2 py-1 bg-amber-100 text-amber-700 text-sm font-bold">FAIR</span></td>
 ...
 <td className="px-6 py-4"><span className="px-2 py-1 bg-red-100 text-red-700 text-sm font-bold">CRITICAL</span></td>
 ...
 <p className="text-xs font-mono bg-white p-2 border border-gray-300">v=DMARC1; p=none; rua=mailto:dmarc@yourdomain.com</p>
 </div>
 <div className="pb-4 border-b border-gray-200">
 ...
 <a href="/dashboard/infrastructure" className="px-6 py-2 bg-green-600 text-white font-bold hover:bg-green-700 transition-colors">
 Go to Dashboard
 </a>
 <a href="/docs/monitoring" className="px-6 py-2 bg-white text-green-700 font-bold border border-green-200 hover:bg-green-50 transition-colors">
