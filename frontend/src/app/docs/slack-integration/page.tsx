...
export default function SlackIntegrationPage() {
 ...
 <div className="bg-purple-50 border border-purple-200 p-6 mb-8">
 <ul className="space-y-6">
 <li className="flex flex-col gap-2">
 <code className="text-black bg-white px-3 py-2 w-fit border border-purple-200 font-bold shadow-sm whitespace-nowrap">
