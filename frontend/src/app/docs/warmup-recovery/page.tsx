...
export default function WarmupRecoveryPage() {
 ...
 <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 p-8 mb-12">
 ...
 <li>1. Webhook receives <code className="px-2 py-1 bg-gray-100 ">EMAIL_BOUNCED</code> event</li>
 <li>2. Calculate bounce rate: 3.3% &gt; 3% threshold</li>
 <li>3. ✅ Update mailbox: <code className="px-2 py-1 bg-red-100 text-red-700">status = 'paused', recovery_phase = 'paused'</code></li>
 ...
 <div className="bg-white p-4 mb-4">
 <ol className="text-sm text-gray-700 space-y-1 m-0 pl-4">
 <li>1. Check <code className="px-2 py-1 bg-gray-100 ">cooldown_until</code> timestamp</li>
 <li>2. ✅ Transition: <code className="px-2 py-1 bg-gray-100 ">PAUSED → QUARANTINE</code></li>
 ...
 {/* Day 3: DNS Passes */}
 <div className="bg-orange-50 border border-orange-200 p-6 mb-6">
 <div className="flex items-center gap-3 mb-3">
 ...
 <div className="bg-white p-4 mb-4">
 <ol className="text-sm text-gray-700 space-y-1 m-0 pl-4">
 <li>1. ✅ Transition: <code className="px-2 py-1 bg-gray-100 ">QUARANTINE → RESTRICTED_SEND</code></li>
 <li>2. 🆕 <strong>Enable platform warmup:</strong>
 <ul className="pl-4 mt-1">
 <li>• <code className="px-2 py-1 bg-gray-100 ">total_warmup_per_day: 10</code></li>
 <li>• <code className="px-2 py-1 bg-gray-100 ">daily_rampup: 0</code> (flat volume)</li>
 <li>• <code className="px-2 py-1 bg-gray-100 ">reply_rate_percentage: 30</code></li>
 </ul>
 </li>
 <li>3. ✅ Reset tracking: <code className="px-2 py-1 bg-gray-100 ">phase_clean_sends = 0, phase_bounces = 0</code></li>
 ...
 <li>2. Get <code className="px-2 py-1 bg-gray-100 ">total_sent_count</code>, <code className="px-2 py-1 bg-gray-100 ">total_spam_count</code>, <code className="px-2 py-1 bg-gray-100 ">warmup_reputation</code></li>
 <li>3. Check graduation criteria: <strong>15 clean sends, 0 spam</strong></li>
 <li>4. If criteria met → Auto-graduate to <code className="px-2 py-1 bg-green-100 text-green-700">WARM_RECOVERY</code></li>
 </ol>
 </div>
 ...
 <li>• Day 3: 10 sends → <code className="px-2 py-1 bg-gray-100 ">total_sent_count = 10</code></li>
 <li>• Day 4: 10 sends → <code className="px-2 py-1 bg-gray-100 ">total_sent_count = 20</code> ✅ <strong>Ready for graduation!</strong></li>
 </ul>
 </div>
 </div>
 ...
 <p className="text-sm text-gray-700 mb-2"><strong>Example Timeline:</strong></p>
 <ul className="text-sm text-gray-700 space-y-1 m-0 pl-4">
 <li>• Day 5: 50 sends (with rampup) → <code className="px-2 py-1 bg-gray-100 ">total_sent_count = 50, days = 1</code></li>
 <li>• Day 6: 55 sends → <code className="px-2 py-1 bg-gray-100 ">total_sent_count = 105, days = 2</code></li>
 <li>• Day 7: 60 sends → <code className="px-2 py-1 bg-gray-100 ">total_sent_count = 165, days = 3</code> ✅ <strong>Ready!</strong></li>
 </ul>
 </div>
 <div className="bg-white p-4">
 <p className="text-sm text-gray-700 mb-2"><strong>Auto-Graduation:</strong></p>
 <ol className="text-sm text-gray-700 space-y-1 m-0 pl-4">
 <li>1. ✅ Transition: <code className="px-2 py-1 bg-gray-100 ">WARM_RECOVERY → HEALTHY</code></li>
 ...
 <p className="text-gray-700 mb-4">
 If mailbox bounces during <code className="px-2 py-1 bg-red-100 text-red-700">RESTRICTED_SEND</code> or <code className="px-2 py-1 bg-red-100 text-red-700">WARM_RECOVERY</code>:
 </p>
 <div className="bg-white p-4">
 <ol className="text-sm text-gray-700 space-y-1 m-0 pl-4">
 <li>1. Webhook receives <code className="px-2 py-1 bg-gray-100 ">EMAIL_BOUNCED</code> event</li>
 <li>2. Check <code className="px-2 py-1 bg-gray-100 ">recovery_phase</code>: <em>restricted_send</em> or <em>warm_recovery</em></li>
 <li>3. ✅ <strong>IMMEDIATE REGRESSION</strong> to <code className="px-2 py-1 bg-red-100 text-red-700">PAUSED</code></li>
 ...
 <code className="px-2 py-1 bg-gray-100 ">10 emails/day</code>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Rampup:</span>
 <code className="px-2 py-1 bg-gray-100 ">0 (flat)</code>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Target Engagement:</span>
 <code className="px-2 py-1 bg-gray-100 ">30% reply rate</code>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Graduation:</span>
 <code className="px-2 py-1 bg-gray-100 ">15 clean sends</code>
 </div>
 </div>
 </div>
 ...
 <div className="flex justify-between">
 <span className="text-gray-600">Daily Volume:</span>
 <code className="px-2 py-1 bg-gray-100 ">50 emails/day</code>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Rampup:</span>
 <code className="px-2 py-1 bg-gray-100 ">5 (gradual increase)</code>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Target Engagement:</span>
 <code className="px-2 py-1 bg-gray-100 ">40% reply rate</code>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Graduation:</span>
 <code className="px-2 py-1 bg-gray-100 ">50 sends, 3+ days</code>
 </div>
 </div>
 </div>
 </div>
