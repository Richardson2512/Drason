...
export default function SmartleadIntegrationPage() {
 ...
 <li><strong>3.</strong> Copy your API key (format: <code className="px-2 py-1 bg-gray-100 text-gray-700">sl_live_xxxxxxxxxxxx</code>)</li>
 </ol>
 </div>
 ...
 <code className="text-green-600 bg-green-50 px-3 py-2 text-sm inline-block">https://api.superkabe.com/api/monitor/smartlead-webhook</code>
 </div>
 <div>
 ...
 <code className="text-blue-600 bg-blue-50 px-3 py-2 text-sm inline-block mt-1">YOUR_ORGANIZATION_ID</code>
 ...
 <div className="mt-2 bg-white border border-gray-200 p-4 space-y-3 text-sm">
 <div>
 <p className="font-semibold text-gray-700 mb-1">Webhook Name:</p>
 <code className="text-blue-600 bg-blue-50 px-2 py-1 ">Superkabe Monitoring</code>
 </div>
 <div>
 <p className="font-semibold text-gray-700 mb-1">Webhook URL:</p>
 <code className="text-green-600 bg-green-50 px-2 py-1 text-xs">https://api.superkabe.com/api/monitor/smartlead-webhook</code>
 </div>
 </div>
 </li>
 <li>
 <strong>3. Add Custom Header</strong>
 <div className="mt-2 bg-white border border-gray-200 p-4 text-sm">
 ...
 <code className="text-blue-600 bg-blue-50 px-2 py-1 ">x-organization-id</code>
 </div>
 <div>
 <p className="text-gray-700 mb-1">Header Value:</p>
 <code className="text-blue-600 bg-blue-50 px-2 py-1 ">YOUR_ORG_ID</code>
 ...
 <div className="mt-2 bg-white border border-gray-200 p-4">
 <p className="text-gray-500 text-sm mb-3">Check the following event types:</p>
 <ul className="space-y-2 text-sm">
 <li className="flex items-center gap-2">
 <span className="text-green-600">☑</span>
 <code className="px-2 py-1 bg-green-50 text-green-600">email_sent</code>
 <span className="text-gray-500">— Tracks send volume</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-red-500">☑</span>
 <code className="px-2 py-1 bg-red-50 text-red-600">email_bounce</code>
 <span className="text-gray-500">— Critical for monitoring</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-red-500">☑</span>
 <code className="px-2 py-1 bg-red-50 text-red-600">hard_bounce</code>
 <span className="text-gray-500">— Hard failures</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-amber-500">☑</span>
 <code className="px-2 py-1 bg-amber-50 text-amber-600">soft_bounce</code>
 <span className="text-gray-500">— Logged, not counted</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-red-500">☑</span>
 <code className="px-2 py-1 bg-red-50 text-red-600">delivery_failure</code>
 ...
 <li><strong>2.</strong> Wait 1-2 minutes for the <code className="px-2 py-1 bg-gray-100 text-gray-700">email_sent</code> webhook</li>
 ...
 <div className="mt-3 bg-white border border-gray-200 p-4 text-xs">
 <ul className="space-y-1 text-gray-600">
 <li>• <code className="text-green-600 bg-green-50 px-1 ">EMAIL_SENT</code> event from Smartlead</li>
 <li>• <code className="text-blue-600 bg-blue-50 px-1 ">MONITORING</code> action for mailbox</li>
 ...
 <td className="px-6 py-4 text-gray-600">Verify <code className="px-2 py-1 bg-gray-100 ">x-organization-id</code> header is correct</td>
 </tr>
 <tr>
 <td className="px-6 py-4 text-gray-700">Events not appearing</td>
 <td className="px-6 py-4 text-gray-600">Check webhook URL ends with <code className="px-2 py-1 bg-gray-100 ">/smartlead-webhook</code></td>
 </tr>
 <tr>
 ...
 {/* Next Steps */}
 <div className="bg-green-50 border border-green-200 p-6 mt-12">
