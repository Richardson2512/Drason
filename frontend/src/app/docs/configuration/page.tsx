export default function ConfigurationPage() {
    return (
        <div className="prose prose-lg text-gray-700 max-w-none">
            ...
            <h2 className="text-3xl font-bold mb-4 mt-12">Integration Setup</h2>
            <p className="text-gray-600 mb-6">
                Drason integrates with Clay and Smartlead to monitor your outbound infrastructure.
            </p>

            <h3 className="text-2xl font-semibold mb-3 mt-8">Smartlead API Key</h3>
            <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                ...
                <div className="bg-gray-50 rounded p-4">
                    <p className="text-sm text-gray-400 mb-2">API Key Format:</p>
                    <code className="text-blue-300">sl_live_xxxxxxxxxxxxxxxxxxxx</code>
                </div>
            </div>

            <h3 className="text-2xl font-semibold mb-3 mt-8">Clay Webhook</h3>
            <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <p className="text-gray-600 mb-4">
                    <strong>Webhook URL:</strong>
                </p>
                <div className="bg-gray-50 rounded p-4 mb-4">
                    <code className="text-green-300">https://api.drason.com/webhooks/clay</code>
                </div>
                <p className="text-gray-600 mb-4">
                    <strong>Required Fields:</strong>
                </p>
                <ul className="space-y-1 text-gray-600 text-sm">
                    <li>• <code className="px-2 py-1 bg-gray-50 rounded">email</code></li>
                    <li>• <code className="px-2 py-1 bg-gray-50 rounded">firstName</code></li>
                    <li>• <code className="px-2 py-1 bg-gray-50 rounded">lastName</code></li>
                    <li>• <code className="px-2 py-1 bg-gray-50 rounded">company</code></li>
                    <li>• <code className="px-2 py-1 bg-gray-50 rounded">campaignId</code> — Smartlead campaign ID to route to</li>
                </ul>
            </div>

            <h2 className="text-3xl font-bold mb-4 mt-12">Threshold Configuration</h2>
            <p className="text-gray-600 mb-6">
                All monitoring thresholds are configurable at the organization level. Default values are production-hardened.
            </p>

            <h3 className="text-2xl font-semibold mb-3 mt-8">Mailbox-Level Thresholds</h3>
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden mb-6">
                <table className="w-full text-left">
                    <thead className="bg-gray-50">
                        <tr>
                            <th className="px-6 py-3 text-gray-600">Threshold</th>
                            <th className="px-6 py-3 text-gray-600">Default Value</th>
                            <th className="px-6 py-3 text-gray-600">Description</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-700">
                        <tr>
                            <td className="px-6 py-4 text-yellow-400 font-mono text-sm">MAILBOX_WARNING_BOUNCES</td>
                            <td className="px-6 py-4 text-gray-600">3</td>
                            <td className="px-6 py-4 text-gray-600">Bounces to trigger warning</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-yellow-400 font-mono text-sm">MAILBOX_WARNING_WINDOW</td>
                            <td className="px-6 py-4 text-gray-600">60</td>
                            <td className="px-6 py-4 text-gray-600">Sends within warning window</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-red-400 font-mono text-sm">MAILBOX_PAUSE_BOUNCES</td>
                            <td className="px-6 py-4 text-gray-600">5</td>
                            <td className="px-6 py-4 text-gray-600">Bounces to trigger pause</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-red-400 font-mono text-sm">MAILBOX_PAUSE_WINDOW</td>
                            <td className="px-6 py-4 text-gray-600">100</td>
                            <td className="px-6 py-4 text-gray-600">Sends within pause window</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">ROLLING_WINDOW_SIZE</td>
                            <td className="px-6 py-4 text-gray-600">100</td>
            ...
            <h3 className="text-2xl font-semibold mb-3 mt-8">Domain-Level Thresholds</h3>
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden mb-6">
                <table className="w-full text-left">
                    <thead className="bg-gray-50">
                        <tr>
                    ...
                    <tbody className="divide-y divide-gray-700">
                        <tr>
                            <td className="px-6 py-4 text-yellow-400 font-mono text-sm">DOMAIN_WARNING_RATIO</td>
                            <td className="px-6 py-4 text-gray-600">0.3</td>
                            <td className="px-6 py-4 text-gray-600">30% unhealthy → warning</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-red-400 font-mono text-sm">DOMAIN_PAUSE_RATIO</td>
                            <td className="px-6 py-4 text-gray-600">0.5</td>
                            <td className="px-6 py-4 text-gray-600">50% unhealthy → pause</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">DOMAIN_MINIMUM_MAILBOXES</td>
                            <td className="px-6 py-4 text-gray-600">3</td>
            ...
            <h3 className="text-2xl font-semibold mb-3 mt-8">Risk Score Thresholds</h3>
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden mb-6">
                <table className="w-full text-left">
                    <thead className="bg-gray-50">
                        <tr>
                    ...
                    <tbody className="divide-y divide-gray-700">
                        <tr>
                            <td className="px-6 py-4 text-red-400 font-mono text-sm">HARD_RISK_CRITICAL</td>
                            <td className="px-6 py-4 text-gray-600">60</td>
                            <td className="px-6 py-4 text-gray-600">Hard score → blocks execution</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-yellow-400 font-mono text-sm">HARD_RISK_WARNING</td>
                            <td className="px-6 py-4 text-gray-600">40</td>
                            <td className="px-6 py-4 text-gray-600">Hard score → warning state</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">SOFT_RISK_HIGH</td>
                            <td className="px-6 py-4 text-gray-600">75</td>
                            <td className="px-6 py-4 text-gray-600">Soft score → logs only</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">SOFT_RISK_WARNING</td>
            ...
            <h3 className="text-2xl font-semibold mb-3 mt-8">Cooldown Configuration</h3>
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden mb-6">
                <table className="w-full text-left">
                    <thead className="bg-gray-50">
                        <tr>
                    ...
                    <tbody className="divide-y divide-gray-700">
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">COOLDOWN_MINIMUM_MS</td>
                            <td className="px-6 py-4 text-gray-600">3600000</td>
                            <td className="px-6 py-4 text-gray-600">1 hour minimum</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">COOLDOWN_MULTIPLIER</td>
                            <td className="px-6 py-4 text-gray-600">2</td>
                            <td className="px-6 py-4 text-gray-600">Exponential backoff</td>
                        </tr>
                        <tr>
                            <td className="px-6 py-4 text-blue-400 font-mono text-sm">COOLDOWN_MAX_MS</td>
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-6 mt-8 mb-8">
                <h3 className="text-xl font-bold text-yellow-400 mb-2">⚠️ Tuning Warning</h3>
                <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-3xl font-bold mb-4 mt-12">System Mode</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6">
                    ...
                    <p className="text-gray-400 text-xs">Use for: Testing and learning baseline metrics</p>
                </div>
                ...
                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-6">
                    ...
                    <p className="text-gray-400 text-xs">Use for: Reviewing automation suggestions</p>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-6">
                    ...
                    <p className="text-gray-400 text-xs">Use for: Production-ready automated safety</p>
                </div>
            </div>

            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6 mt-8">
                <h3 className="text-xl font-bold text-blue-400 mb-2">🎯 Best Practice</h3>
                <p className="text-gray-600 mb-4">
