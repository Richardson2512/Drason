...
export default function PlatformRulesPage() {
 ...
 <td className="px-6 py-4 text-gray-600">Domain → <code className="px-2 py-1 bg-amber-50 text-amber-600">warning</code></td>
 </tr>
 <tr>
 <td className="px-6 py-4 text-red-600 font-semibold">PAUSE</td>
 <td className="px-6 py-4 text-gray-600">50% unhealthy</td>
 <td className="px-6 py-4 text-gray-600">Domain → <code className="px-2 py-1 bg-red-50 text-red-600">paused</code> + cascade</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <strong>Formula:</strong> <code className="px-2 py-1 bg-white text-blue-600">Cooldown = 1 hour × 2^(consecutive_pauses - 1)</code>
 </p>
 <p className="text-gray-700 mb-4">
