...
export default function MonitoringPage() {
 ...
 <strong>Action:</strong> Mailbox transitions to <code className="text-amber-600 bg-amber-100 px-1 ">warning</code> state. Logging intensifies. Operators alerted.
 </p>
 </div>
 </div>
 ...
 <td className="px-6 py-4 text-gray-600">Domain enters <code className="px-2 py-1 bg-amber-50 text-amber-600">warning</code></td>
 </tr>
 <tr>
