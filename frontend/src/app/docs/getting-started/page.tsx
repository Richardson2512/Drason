...
export default function GettingStartedPage() {
    return (
        <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
                Superkabe does not send emails. It validates every lead before it reaches your sender, monitors your mailboxes and domains in real time, auto-pauses degraded infrastructure before it causes permanent damage, and automatically heals paused mailboxes through a graduated 5-phase recovery pipeline.
            </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    ...
                    <div className="flex items-start gap-2 text-blue-800"><span className="text-blue-500 mt-0.5">▸</span> <strong>Multi-Platform</strong> — Works with Smartlead, Instantly, and EmailBison through a unified platform adapter</div>
                </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-8 shadow-lg shadow-gray-100">
                <ol className="space-y-4 text-gray-600 list-decimal list-inside">
                    ...
                    <li><strong className="text-gray-900">Platform Push:</strong> Validated, routed leads are pushed to your sending platform (Smartlead, Instantly, or EmailBison) via API. Lead status changes to ACTIVE on successful push.</li>
            ...
            <p className="text-gray-600">
                Sign up at <code className="px-2 py-1 bg-gray-100 border border-gray-200 rounded text-gray-800">superkabe.com/signup</code> and choose your pricing tier.
            </p>

            <h3 className="text-2xl font-semibold mb-3 mt-8 text-gray-900">2. Connect Your Sending Platform</h3>
            <p className="text-gray-600 mb-4">
                Navigate to <strong className="text-gray-900">Configuration</strong> and add your sending platform API key (Smartlead, EmailBison, or Instantly):
            </p>
            ...
            <p className="text-gray-600 mb-2">
                Include header: <code className="px-2 py-1 bg-gray-100 border border-gray-200 rounded text-gray-800">x-organization-id: YOUR_ORG_ID</code>
            </p>
            <p className="text-gray-600">
            ...
            <ol className="space-y-3 text-gray-600 list-decimal list-inside mb-8">
                ...
                <li>Push validated leads to Smartlead, Instantly, or EmailBison via API</li>
