...
export default function AccountManagementPage() {
 ...
 <div className="bg-white border-2 border-gray-200 p-8 mb-8 shadow-sm">
 <ol className="space-y-4">
 <li className="flex items-start gap-3">
 ...
 <a href="/docs/help/billing" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
