...
export default function AutoHealingPage() {
 // HowTo rich result was deprecated by Google in Sept 2023 (now restricted
 // to Android how-tos). The TechArticle schema injected by docs/layout.tsx
 // is the right shape for this page; no per-page schema needed.
 return (
 <>
 ...
 <div className="bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-200 p-8 mb-12">
 ...
 <div className="bg-red-50 p-4 mb-3 border border-red-100">
 ...
 <div className="bg-amber-50 p-4 mb-3 border border-amber-100">
 ...
 <div className="bg-blue-50 p-4 mb-3 border border-blue-100">
 ...
 <div className="bg-green-50 p-4 mb-3 border border-green-100">
 ...
 {/* What If I Relapse */}
 <div className="bg-red-50 border-2 border-red-200 p-6 mb-12">
 ...
 <a href="/docs/help/status-colors" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 → Understanding Status Colors
 </a>
 <a href="/docs/help/dns-setup" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 → DNS Setup Guide
 </a>
 </div>
 </div>
