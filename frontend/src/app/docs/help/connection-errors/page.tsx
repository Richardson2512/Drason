...
export default function ConnectionErrorsPage() {
 ...
 <div className="text-sm text-gray-500 mb-3 font-mono bg-gray-50 px-3 py-1 inline-block">
 ...
 className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 text-sm font-medium hover:bg-blue-100 transition-colors border border-blue-200"
 >
 ...
 <div id="auth-failed" className="bg-white border-2 border-amber-200 p-6 shadow-sm">
 <div className="flex items-start gap-4">
 ...
 {/* ── Connection Refused ── */}
 <div id="connection-refused" className="bg-white border-2 border-purple-200 p-6 shadow-sm">
 <div className="flex items-start gap-4">
 ...
 {/* ── Timeout ── */}
 <div id="timeout" className="bg-white border-2 border-orange-200 p-6 shadow-sm">
 <div className="flex items-start gap-4">
 ...
 {/* ── SSL/TLS ── */}
 <div id="ssl-tls" className="bg-white border-2 border-gray-200 p-6 shadow-sm">
 <div className="flex items-start gap-4">
 ...
 {/* Google */}
 <div id="google" className="bg-white border border-gray-200 p-6 shadow-sm">
 ...
 className="block p-3 bg-blue-50 hover:bg-blue-100 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 ...
 {/* Microsoft */}
 <div id="microsoft" className="bg-white border border-gray-200 p-6 shadow-sm">
 <div className="flex items-center gap-3 mb-4">
 <span className="text-3xl">📬</span>
 ...
 <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 p-8 mb-12">
 <ol className="space-y-4">
 <li className="flex items-start gap-3">
