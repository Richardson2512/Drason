...
export default function CsvUploadPage() {
 ...
 <div className="bg-gray-50 p-4 text-sm font-mono mb-4">
 ...
 <a href="/docs/help/email-validation" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">&rarr; How Does Email Validation Work?</a>
 <a href="/docs/help/validation-credits" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">&rarr; How Do Validation Credits Work?</a>
 <a href="/docs/help/esp-routing" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">&rarr; How Does ESP-Aware Routing Work?</a>
 </div>
 </div>
 </div>
 );
