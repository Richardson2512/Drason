...
export default function AuditLogsPage() {
 ...
 <div className="bg-gradient-to-br from-gray-50 to-blue-50 border border-gray-200 p-6 mb-12">
 ...
 <a href="/docs/help/notifications" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 ...
 <a href="/docs/state-machine" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
