...
export default function ValidationCreditsPage() {
 ...
 <div className="bg-white border border-[#D1CBC5] overflow-hidden mb-12">
 ...
 <a href="/docs/help/billing" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">&rarr; How Does Billing Work?</a>
 ...
 <a href="/docs/help/csv-upload" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">&rarr; How to Upload CSV Leads</a>
 </div>
 </div>
 </div>
 );
