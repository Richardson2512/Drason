    ...
    return (
        <div className="prose prose-lg text-gray-700 max-w-none">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 rounded-2xl p-8 mb-12">
                ...
                <a href="/docs/slack-integration" className="inline-block px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-colors text-sm">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                ...
                <div className="space-y-2">
                    <a href="/docs/help/audit-logs" className="block p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
                        &rarr; How Do Audit Logs Work?
                    </a>
                    <a href="/docs/slack-integration" className="block p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
