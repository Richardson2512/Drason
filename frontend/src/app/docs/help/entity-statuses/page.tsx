...
export default function EntityStatusesPage() {
    return (
        <div className="prose prose-lg text-gray-700 max-w-none">
            ...
            {/* Color Legend */}
            <div className="bg-gradient-to-br from-gray-50 to-blue-50 border-2 border-gray-200 rounded-2xl p-8 mb-12">
            ...
            <div className="space-y-4 mb-12">
                ...
                <div className="bg-white border-l-4 border-amber-500 rounded-r-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
            ...
            <div className="space-y-4 mb-12">
                ...
                <div className="bg-white border-l-4 border-gray-400 rounded-r-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 mb-12 shadow-sm overflow-x-auto">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                ...
                <div className="space-y-2">
                    ...
                    <a href="/docs/help/quarantine" className="block p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
                        &rarr; Why Is My Mailbox In Quarantine?
                    </a>
                    <a href="/docs/help/email-validation" className="block p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
