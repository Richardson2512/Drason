...
export default function CampaignPausedPage() {
 ...
 <div className="bg-white border-2 border-purple-200 p-6 shadow-sm">
 <div className="flex items-start gap-4">
 ...
 <div className="bg-purple-50 p-3 border border-purple-100 mt-2 text-sm text-purple-800">
 ...
 <div className="bg-green-50 border-2 border-green-200 p-6 mb-8">
 ...
 <div className="bg-white p-4 border border-amber-200 flex flex-col items-start lg:flex-row gap-6">
 <div className="flex-1">
 ...
 <div className="bg-white p-4 border border-amber-200 border-l-4 border-l-blue-500">
 ...
 <ul className="text-sm text-gray-600 space-y-2 bg-gray-50 p-3 ">
