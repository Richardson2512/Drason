        ...
        <div className="prose prose-lg text-gray-700 max-w-none">
            ...
            <div className="space-y-4 mb-12">
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm">During your trial, you get full access to all Superkabe features with Starter-level limits (10K leads, 20 domains, 75 mailboxes).</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                ...
                <div className="space-y-2">
                    ...
                    <a href="/docs/help/account-management" className="block p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
