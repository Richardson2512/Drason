...
export const metadata: Metadata = {
    title: 'Clay Integration Guide | Superkabe Docs',
    description: 'Connect Clay tables with Superkabe for automated lead routing, health scoring, and campaign protection.',
