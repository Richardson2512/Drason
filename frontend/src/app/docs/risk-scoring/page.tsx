...
return { allowed: true };`}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
                ...
                <ul className="space-y-2 text-gray-600 text-sm">
                    <li>• <code className="px-2 py-1 bg-white rounded text-gray-700">HARD_RISK_CRITICAL: 60</code> — Blocks execution</li>
                    <li>• <code className="px-2 py-1 bg-white rounded text-gray-700">SOFT_RISK_HIGH: 75</code> — Logs warning only</li>
                </ul>
            </div>
        </div>
    );
