...
export default function DataSyncCoveragePage() {
 ...
 <div className="bg-white border border-gray-200 p-6 mb-6 shadow-sm overflow-x-auto">
 ...
 <div className="bg-green-50 border border-green-200 p-4 mb-8 text-sm text-green-800">
 <strong>Full per-mailbox historical data available:</strong> Smartlead&apos;s mailbox-statistics endpoint returns per-mailbox sent, open, click, reply, and bounce counts for each campaign. Superkabe aggregates these across all campaigns during sync, using <code className="bg-green-100 px-1 ">Math.max()</code> to never overwrite higher webhook-accumulated values. Historical bounce attribution also uses the message-history API for additional accuracy.
 </div>

 <h3 className="text-2xl font-bold mb-3 text-gray-900">Lead Data</h3>
 <div className="bg-white border border-gray-200 p-6 mb-8 shadow-sm overflow-x-auto">
 <table className="w-full text-sm">
 <thead>
 <tr className="border-b border-gray-200">
 <th className="text-left py-2 pr-4 text-gray-900 font-bold">Metric</th>
 ...
 <div className="bg-green-50 border border-green-200 p-4 mb-8 text-sm text-green-800">
 <strong>Instantly has the best mailbox coverage:</strong> The daily analytics endpoint returns actual per-mailbox, per-day stats including <code className="bg-green-100 px-1 ">bounced</code>, <code className="bg-green-100 px-1 ">emails_sent</code>, and <code className="bg-green-100 px-1 ">opens</code>. Superkabe uses these directly with no estimation.
 </div>
 ...
 <p className="text-gray-600 text-sm">
 Through two methods: the mailbox-statistics endpoint provides aggregate bounce counts per mailbox per campaign, and the message-history API provides individual bounce attribution with a <code className="bg-gray-100 px-1 ">from</code> field identifying the sending mailbox. Superkabe uses <code className="bg-gray-100 px-1 ">Math.max()</code> to keep the higher value from either source.
 </p>
 </div>
 <div className="bg-white border border-gray-200 p-6 shadow-sm">
 ...
 <a href="/docs/multi-platform-sync" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 &rarr; Multi-Platform Data Sync
 </a>
 <a href="/docs/help/analytics" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 ...
 <a href="/docs/instantly-integration" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
 &rarr; Instantly Integration Guide
 </a>
 <a href="/docs/emailbison-integration" className="block p-3 bg-white hover:bg-blue-50 transition-colors text-blue-600 hover:text-blue-700 text-sm font-medium">
