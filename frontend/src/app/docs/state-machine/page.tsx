...
export default function StateMachinePage() {
 ...
 <div className="bg-gray-50 border border-gray-200 p-6 mb-8 overflow-x-auto">
...
`}
 ...
 <p className="text-gray-600 mb-6">
 All state transitions are logged in the <code className="px-2 py-1 bg-gray-100 text-gray-700">state_transitions</code> table:
 </p>
