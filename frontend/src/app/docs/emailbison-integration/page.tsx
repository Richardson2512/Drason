...
export default function EmailBisonIntegrationPage() {
 ...
 <code className="text-green-600 bg-green-50 px-3 py-2 text-sm inline-block">https://api.superkabe.com/api/monitor/emailbison-webhook</code>
 </div>
 <div>
 ...
 <li className="flex items-center gap-2"><span className="text-green-500">☑</span> <code className="bg-gray-100 px-1 ">opened</code></li>
 <li className="flex items-center gap-2"><span className="text-green-500">☑</span> <code className="bg-gray-100 px-1 ">clicked</code></li>
 <li className="flex items-center gap-2"><span className="text-green-500">☑</span> <code className="bg-gray-100 px-1 ">replied</code></li>
 <li className="flex items-center gap-2"><span className="text-red-500">☑</span> <code className="bg-gray-100 px-1 ">bounced</code></li>
 <li className="flex items-center gap-2"><span className="text-red-500">☑</span> <code className="bg-gray-100 px-1 ">spam</code></li>
 <li className="flex items-center gap-2"><span className="text-red-500">☑</span> <code className="bg-gray-100 px-1 ">unsubscribed</code></li>
 </ul>
 </div>
 </div>
