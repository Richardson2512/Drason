...
FRONTEND_URL=https://your-frontend-domain.vercel.app`}
 ...
 <p className="text-gray-700 mb-4">
 Webhook endpoint: <code className="px-2 py-1 bg-white text-purple-700 text-sm">https://your-backend-domain.railway.app/api/billing/polar-webhook</code>
 </p>
...
npx ts-node scripts/backfillSubscriptions.ts`}
 ...
 <strong>Expected:</strong> <code className="px-2 py-1 bg-white ">✅ Backfilled 5 organizations with trial status</code>
 </p>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 p-6 mt-12">
