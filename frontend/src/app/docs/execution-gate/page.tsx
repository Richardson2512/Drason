...
export default function ExecutionGatePage() {
 ...
 <div className="bg-white/80 p-3 text-sm">
...
Deferrable: false`}
 ...
 <span className="px-3 py-1 bg-blue-100 border border-blue-200 text-blue-700 font-semibold">held</span>
 <span className="text-gray-400">→</span>
 <p className="text-gray-600">Lead received from Clay, waiting for gate check</p>
 </div>
 <div className="flex items-center gap-4">
 <span className="px-3 py-1 bg-green-100 border border-green-200 text-green-700 font-semibold">active</span>
 <span className="text-gray-400">→</span>
 <p className="text-gray-600">Passed gate, sent to campaign</p>
 </div>
 <div className="flex items-center gap-4">
 <span className="px-3 py-1 bg-amber-100 border border-amber-200 text-amber-700 font-semibold">paused</span>
 <span className="text-gray-400">→</span>
 <p className="text-gray-600">Gate blocked (HEALTH_ISSUE), manual intervention required</p>
 </div>
 <div className="flex items-center gap-4">
 <span className="px-3 py-1 bg-gray-100 border border-gray-200 text-gray-600 font-semibold">completed</span>
 <span className="text-gray-400">→</span>
 ...
 <div className="bg-purple-50 border border-purple-200 p-6 mt-8">
