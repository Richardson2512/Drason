...
export default function InstantlyIntegrationPage() {
 ...
 <code className="block mt-2 text-green-700 bg-green-50 px-3 py-2 text-xs">
 ...
 <code className="text-green-600 bg-green-50 px-3 py-2 text-sm inline-block">
 ...
 <code className="text-blue-600 bg-blue-50 px-3 py-2 text-sm inline-block">
 ...
 <code className="text-green-600 bg-green-50 px-2 py-1 text-xs block">
 https://api.superkabe.com/api/monitor/instantly-webhook
 </code>
 </div>
 </li>
 ...
 <code className="px-2 py-1 bg-green-50 text-green-700">email_sent</code>
 <span className="text-gray-500">— Tracks send volume per mailbox</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-blue-500">☑</span>
 <code className="px-2 py-1 bg-blue-50 text-blue-700">email_opened</code>
 <span className="text-gray-500">— Open rate tracking</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-blue-500">☑</span>
 <code className="px-2 py-1 bg-blue-50 text-blue-700">email_clicked</code>
 <span className="text-gray-500">— Click rate tracking</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-purple-500">☑</span>
 <code className="px-2 py-1 bg-purple-50 text-purple-700">email_replied</code>
 <span className="text-gray-500">— Reply rate tracking</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-red-500">☑</span>
 <code className="px-2 py-1 bg-red-50 text-red-700">email_bounced</code>
 <span className="text-gray-500">— Critical for health monitoring</span>
 </li>
 <li className="flex items-center gap-2">
 <span className="text-amber-500">☑</span>
 <code className="px-2 py-1 bg-amber-50 text-amber-700">email_unsubscribed</code>
 ...
 <div className="bg-purple-50 border-2 border-purple-300 p-6">
 ...
 <li><strong>2.</strong> Wait 1–2 minutes for the <code className="px-2 py-1 bg-gray-100 text-gray-700">email_sent</code> webhook event</li>
 ...
 <td className="px-6 py-4 text-gray-600">Verify the <code className="px-2 py-1 bg-gray-100 ">x-organization-id</code> header value matches your Superkabe Organization ID exactly.</td>
 </tr>
 <tr>
