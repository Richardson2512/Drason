...
export default function SpfLookupClient() {
 ...
 <code className="block text-sm text-gray-800 bg-white p-4 border border-gray-100 font-mono break-all leading-relaxed">
 {result.raw}
 </code>
 </div>
 ...
 <span className={`inline-flex items-center px-2.5 py-1 text-xs font-bold ${qualifierColor(m.qualifier)}`}>
 ...
 <span className={`inline-flex items-center px-2.5 py-1 text-xs font-bold ${qualifierColor(result.allMechanism[0])}`}>
 ...
 <span className="inline-flex items-center px-2.5 py-1 text-xs font-bold bg-gray-100 text-gray-600 shrink-0">Neutral</span>
