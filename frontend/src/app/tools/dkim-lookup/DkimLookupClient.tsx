...
export default function DkimLookupClient() {
 ...
 <p className="font-mono text-sm text-gray-900 bg-gray-50 px-4 py-2 ">{result.queryName}</p>
 </div>
 ...
 <div className="bg-gray-900 text-green-400 p-4 font-mono text-sm overflow-x-auto whitespace-pre-wrap break-all">
 {result.rawRecord}
 </div>
 </div>
 )}
