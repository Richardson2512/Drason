                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-10">
                    ...
                    <div className="space-y-4 text-gray-600 leading-relaxed">
                        ...
                        <ol className="list-decimal list-inside space-y-3 ml-2">
                            ...
                            <li>
                                Search for the <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm font-mono">DKIM-Signature</code> header.
                            </li>
                            <li>
                                Find the <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm font-mono">s=</code> tag &mdash; that value is your selector.
                            </li>
                        </ol>
                        ...
                        <p className="text-sm text-gray-500 mt-2">
                            In this example, the selector is <strong className="text-gray-700">google</strong>. The full DNS lookup would be <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm font-mono">google._domainkey.example.com</code>.
                        </p>
                    </div>
                </div>
            </section>
                                ...
                                {commonSelectors.map((row) => (
                                    <tr key={row.provider} className="border-b border-gray-50 hover:bg-gray-50/50">
                                        ...
                                        <td className="py-3 px-4">
                                            <code className="px-1.5 py-0.5 bg-emerald-50 text-emerald-700 rounded text-xs font-mono">{row.selector}</code>
                                        </td>
                        ...
                        <div className="space-y-4 mt-4">
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div className="flex items-start gap-3">
                                    <code className="px-2 py-1 bg-emerald-100 text-emerald-800 rounded font-mono text-sm font-bold shrink-0">v=DKIM1</code>
                                    <div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div className="flex items-start gap-3">
                                    <code className="px-2 py-1 bg-emerald-100 text-emerald-800 rounded font-mono text-sm font-bold shrink-0">k=rsa</code>
                                    <div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div className="flex items-start gap-3">
                                    <code className="px-2 py-1 bg-emerald-100 text-emerald-800 rounded font-mono text-sm font-bold shrink-0">p=MIIBIj...</code>
                                    <div>
                                        <p className="font-semibold text-gray-900 text-sm">Public Key</p>
                                        <p className="text-sm text-gray-600">The base64-encoded public key used to verify signatures. An empty <code className="px-1 py-0.5 bg-gray-100 rounded text-xs">p=</code> means the key has been revoked.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div className="flex items-start gap-3">
                                    <code className="px-2 py-1 bg-emerald-100 text-emerald-800 rounded font-mono text-sm font-bold shrink-0">t=y</code>
                                    <div>
                                        <p className="font-semibold text-gray-900 text-sm">Flags</p>
                                        <p className="text-sm text-gray-600"><code className="px-1 py-0.5 bg-gray-100 rounded text-xs">t=y</code> means the domain is testing DKIM (receivers should treat failures leniently). <code className="px-1 py-0.5 bg-gray-100 rounded text-xs">t=s</code> means strict mode &mdash; the signing domain must exactly match the From header domain.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div className="flex items-start gap-3">
                                    <code className="px-2 py-1 bg-emerald-100 text-emerald-800 rounded font-mono text-sm font-bold shrink-0">n=...</code>
                                    <div>
