        ...
        <>
                    ...
                    <div className="space-y-6">
                        <div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
                            <div className="flex items-start gap-4">
                                <code className="shrink-0 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-sm font-bold">v=DKIM1</code>
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">Version</h3>
                                    <p className="text-sm text-gray-600">Identifies the record as a DKIM key record. This tag is required and must be the first tag in the record. The only valid value is <code className="text-xs bg-gray-200 px-1 rounded">DKIM1</code>.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
                            <div className="flex items-start gap-4">
                                <code className="shrink-0 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-sm font-bold">k=rsa</code>
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">Key Type</h3>
                                    <p className="text-sm text-gray-600">Specifies the cryptographic algorithm used. <code className="text-xs bg-gray-200 px-1 rounded">rsa</code> is the standard and universally supported. <code className="text-xs bg-gray-200 px-1 rounded">ed25519</code> is newer and produces shorter keys but has limited receiver support.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
                            <div className="flex items-start gap-4">
                                <code className="shrink-0 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-sm font-bold">p=...</code>
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">Public Key</h3>
                                    <p className="text-sm text-gray-600">The base64-encoded public key data. This is the key that receiving servers use to verify DKIM signatures. An empty <code className="text-xs bg-gray-200 px-1 rounded">p=</code> value means the key has been revoked.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
                            <div className="flex items-start gap-4">
                                <code className="shrink-0 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-sm font-bold">t=y / t=s</code>
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">Flags</h3>
                                    <p className="text-sm text-gray-600"><code className="text-xs bg-gray-200 px-1 rounded">t=y</code> indicates testing mode &mdash; failures should not cause rejection. <code className="text-xs bg-gray-200 px-1 rounded">t=s</code> enforces strict alignment, requiring the signing domain to exactly match the From header domain (no subdomains).</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 bg-emerald-50/50 rounded-xl border border-emerald-100">
                            ...
                            <ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside">
                                ...
                                <li>Copy the TXT record value (selector is usually <code className="text-xs bg-white px-1 rounded">google</code>)</li>
                            </ol>
                        </div>
                        ...
                        <div className="p-6 bg-emerald-50/50 rounded-xl border border-emerald-100">
                            ...
                            <ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside">
                                ...
                                <li>Publish both CNAME records (selectors <code className="text-xs bg-white px-1 rounded">selector1</code> and <code className="text-xs bg-white px-1 rounded">selector2</code>)</li>
                            </ol>
                        </div>
                        ...
                        <div className="p-6 bg-emerald-50/50 rounded-xl border border-emerald-100">
                            ...
                            <ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside">
                                ...
                                <li>SendGrid uses CNAME records (selectors <code className="text-xs bg-white px-1 rounded">s1</code> and <code className="text-xs bg-white px-1 rounded">s2</code>)</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        ...
                        <Link
                            key={tool.href}
                            href={tool.href}
                            className={`group block p-6 bg-white rounded-2xl border border-gray-100 hover:border-${tool.color}-200 hover:shadow-lg transition-all duration-300`}
                        >
            ...
            <section className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Link
                        ...
                        className="group block p-6 bg-white rounded-2xl border border-gray-100 hover:border-emerald-200 hover:shadow-lg transition-all duration-300"
                    >
            ...
            <section className="mt-12 mb-8">
                <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-10">
                    ...
                    <Link
                        href="/signup"
                        className="inline-block px-6 py-3 bg-emerald-600 text-white text-sm font-semibold rounded-xl hover:bg-emerald-700 transition-colors"
                    >
                        Start free trial
                    </Link>
                </div>
