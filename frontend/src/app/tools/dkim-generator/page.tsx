...
export default function DkimGeneratorPage() {
 ...
 <p className="text-sm text-gray-600"><code className="text-xs bg-gray-200 px-1 ">t=y</code> indicates testing mode - failures should not cause rejection. <code className="text-xs bg-gray-200 px-1 ">t=s</code> enforces strict alignment, requiring the signing domain to exactly match the From header domain (no subdomains).</p>
 </div>
 </div>
 </div>
 </div>
