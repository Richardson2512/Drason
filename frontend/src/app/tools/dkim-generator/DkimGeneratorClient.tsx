        ...
        <div className="space-y-8">
                ...
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition-all text-sm text-gray-900 placeholder:text-gray-400"
                        />
                        {!selector.trim() && (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition-all text-sm text-gray-900 placeholder:text-gray-400 min-h-[120px] resize-y font-mono"
                        />
                        {keyWarning && (
                    ...
                    {/* Key Type */}
                    <div>
                        <label htmlFor="dkim-keytype" className="block text-sm font-semibold text-gray-700 mb-2">
                            Key Type
                        </label>
                        <select
                            id="dkim-keytype"
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition-all text-sm text-gray-900 bg-white"
                        >
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8">
                ...
                <div className="mb-4">
                    ...
                    <div className="px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 font-mono text-sm text-gray-800 break-all">
                        {dnsName}
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <div className="px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 font-mono text-sm text-gray-800">
                        TXT
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        <div className="bg-gray-900 text-green-400 p-4 pr-16 rounded-xl font-mono text-sm break-all leading-relaxed">
                            {recordValue}
                        </div>
                        <button
                            onClick={handleCopy}
                            className="absolute top-3 right-3 px-3 py-1.5 bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white text-xs font-medium rounded-lg transition-colors flex items-center gap-1.5"
                    ...
                    <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                        <div className="flex items-start gap-2">
                            ...
                            <p className="text-xs text-emerald-800">
                                <strong>Testing mode is enabled.</strong> Receiving servers will log DKIM failures but will not reject emails. Remove the <code className="bg-emerald-100 px-1 rounded">t=y</code> flag once you have confirmed that DKIM signing is working correctly.
                            </p>
                        </div>
                    </div>
                )}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8">
                ...
                <ol className="space-y-3 text-sm text-gray-600">
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>Add a new <strong>TXT</strong> record with the name <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs font-mono">{dnsName}</code>.</span>
                    </li>
                    <li className="flex items-start gap-3">
