    ...
    return (
        <>
                    ...
                    <ol className="space-y-4">
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Publish <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">p=none</code> with a reporting
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        ...
                        <Link
                            key={tool.href}
                            href={tool.href}
                            className="group block p-6 bg-white rounded-2xl border border-gray-100 hover:border-purple-200 hover:shadow-lg transition-all duration-300"
                        >
            ...
            <section className="mt-12 mb-4">
                <div className="bg-purple-50 rounded-2xl border border-purple-100 p-8 md:p-10">
                    ...
                    <Link
                        href="/signup"
                        className="inline-block px-6 py-3 bg-purple-600 text-white text-sm font-semibold rounded-xl hover:bg-purple-700 transition-colors"
                    >
                        Start free trial
                    </Link>
                </div>
