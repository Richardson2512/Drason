...
export default function ToolsPage() {
 ...
 key={tool.href}
 href={tool.href}
 className={`group block p-8 border ${c.border} ${c.bg} ${c.hover} hover:shadow-xl transition-all duration-300`}
 >
 <div className="flex items-start gap-4">
 <div className={`w-12 h-12 ${c.iconBg} flex items-center justify-center shrink-0`}>
