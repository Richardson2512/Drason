        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <p className="mt-3 text-xs text-gray-500">
                    Publish this as a TXT record at <code className="bg-gray-100 px-1 py-0.5 rounded">@</code> (root) of your domain&apos;s DNS.
                </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        className="flex-1 px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none text-sm transition-all"
                    />
                    <button
                        onClick={addIpv4}
                        className="px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 text-sm font-semibold transition-colors shrink-0"
                    >
                        Add
                    </button>
                </div>
                {ipv4List.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-3">
                        {ipv4List.map((ip) => (
                            <span key={ip} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-mono">
                                ip4:{ip}
                ...
                {includeList.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-3">
                        {includeList.map((domain) => (
                            <span key={domain} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-mono">
                                include:{domain}
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none text-sm transition-all w-full max-w-sm bg-white"
                        >
                            <option value="-all">Hard Fail (-all) &mdash; Recommended</option>
