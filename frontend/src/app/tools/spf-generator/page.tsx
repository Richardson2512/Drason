...
export default function SpfGeneratorPage() {
 ...
 <section className="bg-white border border-gray-100 p-8 md:p-10 shadow-sm">
 <h2 className="text-2xl font-bold text-gray-900 mb-6">How SPF Records Work</h2>
 <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
 <p>
 SPF (Sender Policy Framework) is a DNS-based email authentication protocol defined in RFC 7208. When a receiving mail server gets an email claiming to be from your domain, it queries your domain&apos;s DNS for a TXT record starting with <code className="bg-gray-100 px-1.5 py-0.5 text-gray-800">v=spf1</code>. This record contains a list of mechanisms that define which servers are authorized to send email on your behalf.
 </p>
 <p>
 ...
 <div key={item.mechanism} className="p-4 bg-gray-50 border border-gray-100">
 <div className="flex items-start gap-3">
 <code className="bg-gray-900 text-green-400 px-2 py-1 text-xs font-mono shrink-0 mt-0.5">{item.mechanism}</code>
 <div>
 ...
 Each mechanism can be prefixed with a qualifier that determines how a match is treated. If no qualifier is specified, <code className="bg-gray-100 px-1.5 py-0.5 text-gray-800">+</code> (pass) is the default.
 </p>
 ...
 <div key={item.qualifier} className={`p-4 border border-${item.color}-100 bg-${item.color}-50/50`}>
 <div className="flex items-center gap-2 mb-2">
 <code className="bg-gray-900 text-green-400 px-2 py-1 text-sm font-mono">{item.qualifier}</code>
 ...
 {/* CTA */}
 <section className="bg-white border border-gray-100 p-8 md:p-10 shadow-sm text-center">
