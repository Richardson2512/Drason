...
export default function DmarcLookupPage() {
 ...
 <div className="bg-white border border-gray-100 shadow-sm p-6">
 <div className="flex items-center gap-2 mb-3">
 <span className="inline-flex items-center px-3 py-1 text-xs font-bold bg-green-100 text-green-700">p=reject</span>
 </div>
 ...
 Publish <code className="px-1.5 py-0.5 bg-gray-100 text-xs font-mono">v=DMARC1; p=none; rua=mailto:dmarc@yourdomain.com</code> to begin collecting reports without affecting email delivery. Monitor reports for 2-4 weeks to identify all legitimate sending sources.
 </p>
 </div>
 </div>
 <div className="flex items-start gap-4">
 ...
 <p className="text-sm text-gray-600 mt-1">
 Once all legitimate senders pass SPF and DKIM alignment, switch to <code className="px-1.5 py-0.5 bg-gray-100 text-xs font-mono">p=quarantine</code>. Consider using <code className="px-1.5 py-0.5 bg-gray-100 text-xs font-mono">pct=25</code> initially and gradually increasing to 100%.
 </p>
 </div>
 </div>
 <div className="flex items-start gap-4">
 ...
 <p className="text-sm text-gray-600 mt-1">
 After confirming quarantine causes no legitimate email loss, upgrade to <code className="px-1.5 py-0.5 bg-gray-100 text-xs font-mono">p=reject</code> for full protection. This blocks all unauthenticated email from your domain.
 </p>
 </div>
 </div>
 </div>
 ...
 {faqItems.map((item, i) => (
 <details key={i} className="group bg-white border border-gray-100 shadow-sm overflow-hidden">
