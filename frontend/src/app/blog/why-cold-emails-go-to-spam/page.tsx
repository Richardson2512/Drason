    ...
    return (
        <>
            ...
            <article>
                ...
                <p className="snippet-answer text-xl text-blue-900 font-medium mb-8 bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        Other DNS issues that develop over time: DKIM key rotation failures, DMARC policy set to <code className="bg-gray-100 px-1 rounded text-sm">p=none</code> instead of <code className="bg-gray-100 px-1 rounded text-sm">p=quarantine</code> or <code className="bg-gray-100 px-1 rounded text-sm">p=reject</code> (which some ISPs interpret as low confidence), and MX records pointing to inactive servers. These issues do not cause immediate failures during warmup because warmup networks often have lenient spam filters, but real ISP spam filters will flag them.
                    </p>
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-6">
