...
export const alt = 'Best EmailBison Alternatives for Cold Email in 2026 — Superkabe';
            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ fontSize: 72, fontWeight: 800, color: '#111827', lineHeight: 1.05, letterSpacing: '-0.03em', marginBottom: 20 }}>
                        Best EmailBison alternatives
                    </div>
                    <div style={{ fontSize: 26, color: '#4B5563', lineHeight: 1.4, maxWidth: 1000 }}>
                        7 ranked tools for teams that need both high-volume sending economics and the infrastructure protection EmailBison doesn&apos;t ship.
                    </div>
                </div>
