                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <ul className="space-y-3 text-gray-600 text-sm">
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>Real-time monitoring:</strong> Sub-minute polling intervals. Daily dashboards are useless for cold email. You need to know about a bounce spike within minutes, not hours. A tool that checks once per day is a reporting tool, not a monitoring tool.</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>Multi-domain support:</strong> If you are running cold email at any scale, you have multiple sending domains. The tool needs to monitor all of them from a single interface without requiring separate setup for each domain.</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>Automated alerting:</strong> Slack, email, webhook — does not matter how. What matters is that the alert fires within minutes of a threshold breach, not the next time someone logs into the dashboard.</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>Automated response:</strong> This is the difference between monitoring and protection. Auto-pause campaigns when bounce rates exceed thresholds. Auto-remove bad mailboxes. Stop the bleeding without waiting for a human to react.</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>Cold email focus:</strong> The tool needs to understand bounce categories, sender reputation signals, DNS compliance requirements, and the specific patterns that indicate cold email infrastructure is degrading.</li>
                        </ul>
                    </div>
