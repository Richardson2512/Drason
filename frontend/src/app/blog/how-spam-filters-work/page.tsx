        ...
        <>
            ...
            <section className="pb-12 mt-16">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <Link href="/product/email-deliverability-protection" className="bg-blue-50 p-6 rounded-2xl border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
