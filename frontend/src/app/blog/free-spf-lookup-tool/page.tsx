        ...
        <>
            ...
            <article>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-12">
                    ...
                    <ul className="space-y-2 text-blue-800 text-sm">
                        ...
                        <li className="flex items-start gap-2"><span className="text-blue-500 mt-0.5">&#9656;</span> Use <code className="bg-blue-100 px-1 rounded text-xs">-all</code> (hard fail) instead of <code className="bg-blue-100 px-1 rounded text-xs">~all</code> (soft fail) for stronger protection</li>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                        If the sending IP matches an entry in the SPF record, the email passes SPF authentication. If it doesn&apos;t, the receiving server takes action based on the qualifier specified in the record: reject the email (<code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">-all</code>), mark it as suspicious (<code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">~all</code>), or allow it through (<code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">+all</code>, which you should never use).
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-6">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                        An SPF record is a single TXT record published at the root of your domain. It starts with <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">v=spf1</code> and contains a series of mechanisms that define authorized senders. Here&apos;s an example:
                    </p>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                        Each <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">include:</code> mechanism tells receiving servers to also check the referenced domain&apos;s SPF record for authorized IPs. This is how third-party email services like Google Workspace, SendGrid, and Smartlead get authorization to send on your behalf. The <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">-all</code> at the end tells receivers to reject any IP not explicitly authorized.
                    </p>

                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        <h3 className="font-bold text-gray-900 mb-3">SPF Mechanism Types</h3>
                        <ul className="space-y-2 text-gray-600 text-sm">
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <code className="bg-gray-100 px-1 rounded text-xs">include:</code> &mdash; Checks another domain&apos;s SPF record (counts as a DNS lookup)</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <code className="bg-gray-100 px-1 rounded text-xs">ip4:</code> / <code className="bg-gray-100 px-1 rounded text-xs">ip6:</code> &mdash; Authorizes a specific IP address or CIDR range (no lookup cost)</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <code className="bg-gray-100 px-1 rounded text-xs">a</code> &mdash; Authorizes the domain&apos;s A record IP (counts as a lookup)</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <code className="bg-gray-100 px-1 rounded text-xs">mx</code> &mdash; Authorizes IPs from the domain&apos;s MX records (counts as a lookup)</li>
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <code className="bg-gray-100 px-1 rounded text-xs">redirect=</code> &mdash; Delegates SPF evaluation to another domain entirely</li>
                        </ul>
                    </div>

                    <p className="text-gray-600 leading-relaxed mb-6">
                        The critical constraint to understand is the <strong>10-lookup limit</strong>. Every <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">include</code>, <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">a</code>, <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">mx</code>, and <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">redirect</code> mechanism triggers a DNS lookup. If the total number of lookups exceeds 10 &mdash; including nested lookups within included records &mdash; SPF evaluation returns a PermError and the check fails. This failure is silent: you won&apos;t receive any error notification, but every email from that domain will fail SPF authentication.
                    </p>
                    ...
                    <ol className="space-y-4 text-gray-600 mb-8 list-decimal pl-5">
                        <li><strong>Enter your domain</strong> &mdash; Type the domain you want to check (e.g., <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">yourdomain.com</code>) into the input field. Do not include <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">https://</code> or any subdomain prefix.</li>
                        ...
                        <li><strong>Check for issues</strong> &mdash; Look for warnings about exceeding the 10-lookup limit, missing include statements for your email providers, or weak qualifiers like <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">~all</code>.</li>
                    </ol>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                            This is the most dangerous SPF issue because it fails silently. Each <code className="bg-gray-100 px-1 rounded text-xs">include:</code> mechanism triggers at least one DNS lookup, and the included records may contain their own nested includes. Google Workspace alone can consume 3-4 lookups. Add Smartlead, a CRM, and a marketing platform, and you can easily exceed 10.
                        </p>
                        <p className="text-gray-600 text-sm">
                            <strong>Fix:</strong> Use the <Link href="/tools/spf-lookup" className="text-blue-600 hover:underline">SPF lookup tool</Link> to count your total lookups. If you&apos;re over 10, consider flattening your SPF record by replacing <code className="bg-gray-100 px-1 rounded text-xs">include:</code> mechanisms with direct <code className="bg-gray-100 px-1 rounded text-xs">ip4:</code> entries where possible, or use an SPF flattening service.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                            Using <code className="bg-gray-100 px-1 rounded text-xs">~all</code> (tilde, soft fail) instead of <code className="bg-gray-100 px-1 rounded text-xs">-all</code> (hyphen, hard fail) is a common mistake. Soft fail tells receiving servers to accept emails from unauthorized IPs but mark them. Hard fail tells servers to reject them outright. For outbound teams, <code className="bg-gray-100 px-1 rounded text-xs">-all</code> is the correct choice &mdash; it provides stronger protection against spoofing and signals to ISPs that you are serious about authentication.
                        </p>
                        <p className="text-gray-600 text-sm">
                            <strong>Fix:</strong> Change the last mechanism in your SPF record from <code className="bg-gray-100 px-1 rounded text-xs">~all</code> to <code className="bg-gray-100 px-1 rounded text-xs">-all</code>. Make sure all legitimate senders are included first, as hard fail will block unauthorized sources.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                            A domain must have exactly one SPF record. If you have multiple TXT records starting with <code className="bg-gray-100 px-1 rounded text-xs">v=spf1</code>, SPF evaluation returns a PermError and authentication fails for all emails. This commonly happens when different team members or providers add separate SPF records instead of merging them.
                        </p>
                        <p className="text-gray-600 text-sm">
                    ...
                    <div className="space-y-6 mb-12">
                        ...
                        <div className="border border-gray-100 rounded-2xl p-6">
                            ...
                            <p className="text-gray-600 text-sm">The SPF specification (RFC 7208) limits SPF records to a maximum of 10 DNS lookups during evaluation. Each <code className="bg-gray-100 px-1 rounded text-xs">include</code>, <code className="bg-gray-100 px-1 rounded text-xs">a</code>, <code className="bg-gray-100 px-1 rounded text-xs">mx</code>, and <code className="bg-gray-100 px-1 rounded text-xs">redirect</code> mechanism triggers a lookup. If your record exceeds 10, SPF evaluation returns a PermError and authentication fails silently for every email.</p>
                        </div>
                        <div className="border border-gray-100 rounded-2xl p-6">
                            <h3 className="font-bold text-gray-900 mb-2">What is the difference between ~all and -all in SPF?</h3>
                            <p className="text-gray-600 text-sm">The <code className="bg-gray-100 px-1 rounded text-xs">-all</code> qualifier (hard fail) tells receiving servers to reject emails from unauthorized IPs. The <code className="bg-gray-100 px-1 rounded text-xs">~all</code> qualifier (soft fail) tells servers to accept but flag the email. For outbound teams, <code className="bg-gray-100 px-1 rounded text-xs">-all</code> is recommended because it provides stronger domain spoofing protection.</p>
                        </div>
                        <div className="border border-gray-100 rounded-2xl p-6">
            ...
            <section className="pb-12 mt-16">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <Link href="/blog/email-authentication-checker-tools" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
