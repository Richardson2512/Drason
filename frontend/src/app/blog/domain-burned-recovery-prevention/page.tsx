        ...
        <>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <ul className="space-y-2 text-gray-600 text-sm">
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>SPF:</strong> Verify your SPF record includes all legitimate sending sources and ends with <code className="text-sm bg-gray-100 px-1 rounded">-all</code> (hard fail), not <code className="text-sm bg-gray-100 px-1 rounded">~all</code> (soft fail)</li>
                            ...
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>DMARC:</strong> You should have a DMARC record at minimum. For recovery, <code className="text-sm bg-gray-100 px-1 rounded">p=quarantine</code> or <code className="text-sm bg-gray-100 px-1 rounded">p=reject</code> signals to ISPs that you take authentication seriously</li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <ul className="space-y-2 text-gray-600 text-sm">
                            ...
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> <strong>Auto-pause at threshold.</strong> Set your mailboxes to pause at 5 bounces. Not 10. Not 15. Five. One bad list can generate 5 bounces in an hour. That is your signal to stop</li>
                    ...
                    <div className="space-y-6 mb-12">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6">
                            ...
                            <p className="text-gray-600 text-sm">Set auto-pause at 5 bounces per mailbox. ISPs start watching at 2% bounce rate and begin degrading reputation at 5%. With a typical mailbox sending 50 emails per day, 5 bounces represents a 10% bounce rate — already in danger territory. Catching it at 5 instead of 10 or 15 is the difference between a temporary pause and a domain burn.</p>
                        </div>
                        <div className="bg-gray-50 rounded-2xl p-6">
            ...
            <section className="pb-12 mt-16">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <Link href="/docs/help/quarantine" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
                    ...
                    <Link href="/docs/help/auto-healing" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
