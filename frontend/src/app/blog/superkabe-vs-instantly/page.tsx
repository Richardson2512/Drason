...
export default function SuperkabeVsInstantlyPage() {
    ...
    const faqSchema = {
        ...
        "mainEntity": [
            ...
            { "@type": "Question", "name": "Does Superkabe have built-in warmup like Instantly?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Superkabe ships its own built-in warmup pool, so new mailboxes build sending reputation inside the platform with no separate warmup subscription. Instantly's bundled warmup network is one of the largest in the industry; if raw warmup-network size is the primary value driver, Instantly wins. For most teams the warmup quality difference is small once mailboxes are warmed - and Superkabe's protection layer matters more during live sending than warmup volume during the ramp." } },
            ...
            <article>
                ...
                <div className="bg-blue-50 border border-blue-200 p-6 mb-12">
                    ...
                    <ul className="space-y-2 text-blue-800 text-sm">
                        ...
                        <li className="flex items-start gap-2"><span className="text-blue-500 mt-0.5">&#9656;</span> Instantly bundles a strong warmup network and B2B lead database - Superkabe ships its own built-in warmup pool but no built-in lead database</li>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <div className="bg-white border border-gray-100 p-6 mb-6 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Instantly&apos;s warmup network is one of the largest in the industry. New mailboxes ramp via simulated engagement signals (opens, replies, inbox moves). Superkabe runs its own built-in warmup pool so warmup and protection live in one platform, though the pool is smaller than Instantly&apos;s network. If raw warmup-network size is the primary value driver, Instantly wins on this dimension.
                        </p>
                    </div>
                    ...
                    <div className="bg-white border border-gray-200 mb-8 shadow-sm overflow-x-auto table-scroll">
                        <table className="w-full text-left border-collapse min-w-[800px]">
                            ...
                            <tbody>
                                ...
                                <tr className="border-b border-gray-100"><td className="py-3 px-4 text-gray-700 text-xs font-semibold">Built-in warmup</td><td className="py-3 px-4 text-green-600 text-xs font-semibold">Built-in pool</td><td className="py-3 px-4 text-green-600 text-xs font-semibold">Bundled</td></tr>
