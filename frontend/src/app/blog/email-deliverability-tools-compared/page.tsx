    ...
    return (
        <>
            ...
            <section className="pb-12 mt-16">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <Link href="/product/what-is-email-deliverability-protection" className="bg-blue-50 p-6 rounded-2xl border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
                        <h3 className="font-bold text-gray-900 text-sm mb-2">What is Email Deliverability Protection?</h3>
                        <p className="text-gray-500 text-xs">How a DPL differs from traditional monitoring tools</p>
                    </Link>
                    <Link href="/product/smartlead-deliverability-protection" className="bg-blue-50 p-6 rounded-2xl border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
                    ...
                    <Link href="/product/instantly-infrastructure-protection" className="bg-blue-50 p-6 rounded-2xl border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
