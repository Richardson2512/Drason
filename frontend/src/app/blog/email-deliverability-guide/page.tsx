...
export const metadata: Metadata = {
 ...
 description: 'Complete guide to email deliverability: sender reputation, bounce rates, DNS authentication, domain warming, and infrastructure protection.',
 openGraph: {
 title: 'How to protect and master your outbound email deliverability',
...
export default function EmailDeliverabilityGuide() {
 ...
 <p className="text-gray-500 text-xs leading-relaxed">DNS TXT record listing authorized sending IPs. Must use <code className="bg-gray-100 px-1 text-xs">-all</code> (hard fail). Limited to 10 DNS lookups.</p>
 </div>
 <div className="bg-white border border-gray-100 p-6 shadow-sm">
 ...
 <Link href="/signup" className="inline-block px-8 py-3 bg-white text-blue-700 text-sm font-bold hover:bg-blue-50 transition-colors">
 Start Your Trial →
 </Link>
 </div>
 </div>
 ...
 <Link href="/product/outbound-email-infrastructure-monitoring" className="bg-blue-50 p-6 border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
