            ...
            <article>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        The most common SPF failure is simply not including your sending platform in your SPF record. If you send through Google Workspace, your SPF record must include <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">include:_spf.google.com</code>. If you also send through Smartlead, you need their include as well. Every platform that sends email on your behalf must be listed.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        The SPF specification limits DNS lookups to 10 per record. Each <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">include:</code>, <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">a:</code>, <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">mx:</code>, and <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">redirect:</code> mechanism counts as one lookup. But includes can be nested — <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">include:_spf.google.com</code> itself triggers 3-4 additional lookups internally. If your total exceeds 10, SPF returns a PermError and fails.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                        <strong>How to check:</strong> The <Link href="/tools/spf-lookup" className="text-blue-600 hover:text-blue-800">SPF Lookup tool</Link> shows the total lookup count. Alternatively, run <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">dig TXT yourdomain.com</code> and manually trace each include.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                        <strong>How to fix:</strong> Replace <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">include:</code> statements with direct IP addresses where possible. For example, instead of including a third-party service, use their IP range: <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">ip4:198.51.100.0/24</code>. This uses zero DNS lookups. Another option is an SPF flattening service that automatically resolves includes to IPs and keeps your record under the limit.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-6">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        A domain can only have one SPF record (one TXT record starting with <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">v=spf1</code>). If you have two, SPF validation returns a PermError and fails for every email. This commonly happens when one team member adds an SPF record for Google Workspace and another adds a separate one for a transactional email service.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                    ...
                    <div className="bg-gray-900 text-green-400 p-4 rounded-xl font-mono text-sm mb-4 overflow-x-auto">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        The <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">-all</code> mechanism (hard fail) tells receiving servers to reject any email not in your SPF record. The <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">~all</code> mechanism (soft fail) tells them to accept but flag it. If you set <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">-all</code> before you have included every legitimate sending source, you will reject your own emails.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-6">
                        <strong>How to fix:</strong> Switch to <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">~all</code> until you are certain every sending service is included. Monitor for a few weeks using DMARC aggregate reports to confirm no legitimate sources are missing, then switch to <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">-all</code>.
                    </p>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        DKIM keys are published at a specific subdomain: <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">selector._domainkey.yourdomain.com</code>. The selector is provided by your email platform (for Google Workspace, it is usually <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">google</code>). If the CNAME or TXT record is published at the wrong subdomain, or the selector does not match what the email header specifies, DKIM fails.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        DMARC alignment means the domain in the From header must match the domain authenticated by SPF or DKIM. In <strong>relaxed mode</strong> (the default), subdomains count — so mail from <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">user@sub.yourdomain.com</code> aligns with SPF for <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">yourdomain.com</code>. In <strong>strict mode</strong>, the domains must match exactly.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                        If you set <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">aspf=s</code> or <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">adkim=s</code> (strict) in your DMARC record, and your emails come from a subdomain while your authentication is set up on the root domain, alignment fails even though the underlying checks pass.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-6">
                        <strong>How to fix:</strong> Unless you have a specific reason for strict alignment, use relaxed mode. Remove <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">aspf=s</code> and <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">adkim=s</code> from your DMARC record, or explicitly set them to <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">aspf=r</code> and <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">adkim=r</code>.
                    </p>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        <strong>How to fix:</strong> Add a DMARC record as a TXT record at <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">_dmarc.yourdomain.com</code>. Start with a monitoring-only policy:
                    </p>
                    <div className="bg-gray-900 text-green-400 p-4 rounded-xl font-mono text-sm mb-4 overflow-x-auto">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        DMARC has a <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">sp=</code> tag that sets policy for subdomains. If you send from <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">outreach.yourdomain.com</code> but only have a DMARC record on the root domain with <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">sp=reject</code>, emails from the subdomain will be rejected unless the subdomain has its own DMARC record that overrides the parent policy.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-6">
                        <strong>How to fix:</strong> If you use subdomains for sending, either set <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">sp=none</code> on the root domain DMARC record while you set up subdomain authentication, or publish a separate DMARC record for each sending subdomain at <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">_dmarc.subdomain.yourdomain.com</code>.
                    </p>
                    ...
                    <ol className="text-gray-600 space-y-3 mb-6">
                        ...
                        <li><strong>Check DMARC third.</strong> Use the <Link href="/tools/dmarc-lookup" className="text-blue-600 hover:text-blue-800">DMARC Lookup tool</Link> to verify your record exists at <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">_dmarc.yourdomain.com</code> and the policy is appropriate for your current stage.</li>
                        ...
                        <li><strong>Monitor aggregate reports.</strong> Set up the <code className="bg-gray-100 px-2 py-0.5 rounded text-sm">rua=</code> tag in your DMARC record to receive aggregate reports. These reports show every IP that sends email as your domain and whether they pass or fail authentication.</li>
                    </ol>
