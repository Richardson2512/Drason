            ...
            <article>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-12">
                    ...
                    <ul className="space-y-2 text-blue-800 text-sm">
                        ...
                        <li className="flex items-start gap-2"><span className="text-blue-500 mt-0.5">&#9656;</span> Start with <code className="bg-blue-100 px-1 rounded text-xs">p=none</code>, monitor reports, then progress to <code className="bg-blue-100 px-1 rounded text-xs">p=quarantine</code> and <code className="bg-blue-100 px-1 rounded text-xs">p=reject</code></li>
                        ...
                        <li className="flex items-start gap-2"><span className="text-blue-500 mt-0.5">&#9656;</span> Use the <code className="bg-blue-100 px-1 rounded text-xs">pct</code> tag to gradually roll out stricter policies</li>
                    </ul>
                </div>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                            This policy instructs receiving servers to route emails that fail authentication to the spam or junk folder. The email is still delivered, but it is flagged as suspicious. This is a significant step up from <code className="bg-gray-100 px-1 rounded text-xs">p=none</code> because it actively protects your domain from spoofing while still allowing recipients to find misclassified legitimate emails.
                        </p>
                        <p className="text-gray-600 text-sm">
                            <strong>When to use:</strong> After you have monitored with <code className="bg-gray-100 px-1 rounded text-xs">p=none</code> for 2-4 weeks and confirmed all legitimate sources pass authentication.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm">
                            <strong>When to use:</strong> After running <code className="bg-gray-100 px-1 rounded text-xs">p=quarantine</code> successfully for 2-4 weeks with no legitimate emails being affected.
                        </p>
                    </div>

                    <h2 id="rollout-strategy" className="text-2xl font-bold text-gray-900 mt-12 mb-4">The Safe DMARC Rollout Strategy</h2>
                    <p className="text-gray-600 leading-relaxed mb-6">
                        Deploying DMARC too aggressively can block legitimate emails. The recommended rollout strategy uses the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">pct</code> tag to gradually increase enforcement:
                    </p>

                    <ol className="space-y-4 text-gray-600 mb-8 list-decimal pl-5">
                        <li><strong>Week 1-2: p=none</strong> &mdash; Publish a DMARC record with <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">p=none</code> and <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">rua=mailto:your-reports@domain.com</code>. Monitor aggregate reports to identify all email sources.</li>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                        This phased approach ensures you don&apos;t accidentally block legitimate emails. Use the <Link href="/tools/dmarc-generator" className="text-blue-600 hover:underline">DMARC Generator tool</Link> to create records with the correct <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">pct</code> values at each stage of the rollout.
                    </p>
                    ...
                    <ol className="space-y-3 text-gray-600 mb-8 list-decimal pl-5">
                        <li><strong>Enter your domain</strong> &mdash; Type the domain you want to check (e.g., <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">yourdomain.com</code>).</li>
                        <li><strong>Run the lookup</strong> &mdash; The tool queries the TXT record at <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">_dmarc.yourdomain.com</code>.</li>
                    ...
                    <ol className="space-y-3 text-gray-600 mb-8 list-decimal pl-5">
                        ...
                        <li><strong>Copy the record</strong> &mdash; The tool outputs a complete DMARC TXT record ready to publish at <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">_dmarc.yourdomain.com</code>.</li>
                    </ol>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm">
                            Relaxed alignment allows the organizational domain (e.g., <code className="bg-gray-100 px-1 rounded text-xs">yourdomain.com</code>) to match, even if the specific subdomain differs. For example, an email from <code className="bg-gray-100 px-1 rounded text-xs">mail.yourdomain.com</code> would align with DKIM signed by <code className="bg-gray-100 px-1 rounded text-xs">yourdomain.com</code>. This is the default mode and is <strong>recommended for most outbound teams</strong> because it accommodates subdomains and third-party sending services.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <ul className="space-y-2 text-gray-600 text-sm">
                            ...
                            <li className="flex items-start gap-2"><span className="text-blue-500 mt-1">&#9679;</span> Published DMARC record (at minimum <code className="bg-gray-100 px-1 rounded text-xs">p=none</code>)</li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6 mb-12">
                        <div className="border border-gray-100 rounded-2xl p-6">
                            ...
                            <p className="text-gray-600 text-sm"><code className="bg-gray-100 px-1 rounded text-xs">p=none</code> tells receiving servers to take no action on failing emails &mdash; it is monitoring only. <code className="bg-gray-100 px-1 rounded text-xs">p=quarantine</code> instructs servers to route failing emails to spam. <code className="bg-gray-100 px-1 rounded text-xs">p=reject</code> tells servers to block failing emails entirely. Start with none, progress to quarantine, and eventually to reject.</p>
                        </div>
                        <div className="border border-gray-100 rounded-2xl p-6">
                        ...
                        <div className="border border-gray-100 rounded-2xl p-6">
                            ...
                            <p className="text-gray-600 text-sm">Monitor with <code className="bg-gray-100 px-1 rounded text-xs">p=none</code> for 2-4 weeks while reviewing aggregate reports. Once all legitimate email sources pass authentication, move to <code className="bg-gray-100 px-1 rounded text-xs">p=quarantine</code>. After another 2-4 weeks with no issues, progress to <code className="bg-gray-100 px-1 rounded text-xs">p=reject</code>. Use the <code className="bg-gray-100 px-1 rounded text-xs">pct</code> tag to roll out gradually.</p>
                        </div>
                        <div className="border border-gray-100 rounded-2xl p-6">
                            <h3 className="font-bold text-gray-900 mb-2">Can I apply DMARC to only a percentage of my emails?</h3>
                            <p className="text-gray-600 text-sm">Yes. The <code className="bg-gray-100 px-1 rounded text-xs">pct</code> tag specifies the percentage of failing emails to which the policy applies. For example, <code className="bg-gray-100 px-1 rounded text-xs">pct=25</code> means only 25% of failing emails will be quarantined or rejected. Start with 25%, increase to 50%, then 100% once confident.</p>
                        </div>
                    </div>
