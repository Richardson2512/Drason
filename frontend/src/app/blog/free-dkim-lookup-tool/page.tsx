        ...
        <>
            ...
            <article>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                        The <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">d=</code> tag specifies the signing domain, and the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">s=</code> tag specifies the selector. Together, they tell the receiving server to look up the public key at <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">selector._domainkey.domain.com</code>. This is the exact record our <Link href="/tools/dkim-lookup" className="text-blue-600 hover:underline">DKIM lookup tool</Link> queries.
                    </p>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                            Send a test email from your domain, then view the full headers (in Gmail: click the three dots &rarr; &quot;Show original&quot;). Look for the <code className="bg-gray-100 px-1 rounded text-xs">DKIM-Signature</code> header and find the <code className="bg-gray-100 px-1 rounded text-xs">s=</code> tag. The value after <code className="bg-gray-100 px-1 rounded text-xs">s=</code> is your selector.
                        </p>
                    </div>
                    ...
                    <ol className="space-y-4 text-gray-600 mb-8 list-decimal pl-5">
                        ...
                        <li><strong>Enter your DKIM selector</strong> &mdash; Type the selector used by your email provider (e.g., <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">google</code> for Google Workspace).</li>
                        <li><strong>Run the lookup</strong> &mdash; The tool queries the TXT record at <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">selector._domainkey.yourdomain.com</code>.</li>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm">
                            <strong>Fix:</strong> Check the DKIM-Signature header in a test email to confirm the exact selector being used. Then verify that a DKIM TXT record exists at that exact <code className="bg-gray-100 px-1 rounded text-xs">selector._domainkey.yourdomain.com</code> location.
                        </p>
                    </div>
                        ...
                        <table className="w-full text-sm border-collapse">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="p-3 text-gray-600 border-b border-gray-100"><code className="bg-gray-100 px-1 rounded text-xs">google</code></td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 text-gray-600 border-b border-gray-100"><code className="bg-gray-100 px-1 rounded text-xs">selector1</code>, <code className="bg-gray-100 px-1 rounded text-xs">selector2</code></td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 text-gray-600 border-b border-gray-100"><code className="bg-gray-100 px-1 rounded text-xs">s1</code>, <code className="bg-gray-100 px-1 rounded text-xs">s2</code></td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 text-gray-600 border-b border-gray-100"><code className="bg-gray-100 px-1 rounded text-xs">smtp</code>, <code className="bg-gray-100 px-1 rounded text-xs">k1</code></td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 text-gray-600 border-b border-gray-100"><code className="bg-gray-100 px-1 rounded text-xs">20yymmdd</code></td>
