...
<div className="prose prose-lg max-w-none">
 ...
 <Link href="/blog/introducing-infrastructure-assessment" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
 ...
 <Link href="/product/sender-reputation-monitoring" className="bg-blue-50 p-6 border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
