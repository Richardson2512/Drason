        ...
        <>
            ...
            <section className="pb-12 mt-16">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <Link href="/blog/zerobounce-catch-all-handling" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-4">
                    ...
                    <Link href="/" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
