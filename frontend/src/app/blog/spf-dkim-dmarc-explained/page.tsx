...
export const metadata: Metadata = {
 ...
 description: 'How SPF, DKIM, and DMARC protect your sender identity. Technical setup guide with common misconfiguration pitfalls that cause inbox placement failure.',
 openGraph: {
 title: 'SPF, DKIM & DMARC Setup Guide for Outbound Email Teams',
...
export default function SpfDkimDmarcArticle() {
 ...
 <p className="text-gray-600 leading-relaxed mb-6">
 The <code className="bg-gray-100 px-1.5 py-0.5 text-sm">-all</code> at the end is critical. It tells receiving servers to reject emails from any IP not explicitly listed. Using <code className="bg-gray-100 px-1.5 py-0.5 text-sm">~all</code> (soft fail) instead of <code className="bg-gray-100 px-1.5 py-0.5 text-sm">-all</code> (hard fail) is a common misconfiguration that weakens SPF protection.
 </p>
 ...
 <p className="text-gray-600 leading-relaxed mb-6">
 The <code className="bg-gray-100 px-1.5 py-0.5 text-sm">rua</code> tag specifies where aggregate reports should be sent. These reports contain data about who is sending email using your domain, including unauthorized senders. For multi-domain outbound operations, these reports are essential for detecting infrastructure compromise.
 </p>
 ...
 <Link href="/guides/email-deliverability-glossary" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
