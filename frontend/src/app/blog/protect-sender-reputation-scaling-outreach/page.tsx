...
export default function ProtectSenderReputationArticle() {
 ...
 <p className="text-gray-600 text-sm leading-relaxed">
 The primary trigger is rate-based: a mailbox enters warning at 2% bounce rate and pauses at 3% bounce rate once it has cleared the 60-send minimum (the rolling window is the last 100 sends). A 5-bounce absolute safety net catches low-volume mailboxes before they accumulate enough sends for the rate threshold to apply. No human in the loop. No Slack thread. Traffic redistributes to healthy mailboxes. This is the most important automation in the entire stack because it limits the blast radius of any single failure.
 </p>
 </div>
 </div>
 ...
 <Link href="/blog/reduce-cold-email-bounce-rate" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
