...
<div className="prose prose-lg max-w-none">
 ...
 <Link href="/tools/spf-lookup" className="bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all block">
 ...
 <Link href="/tools/spf-generator" className="bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all block">
 ...
 <Link href="/tools/dkim-lookup" className="bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all block">
 ...
 <Link href="/tools/dkim-generator" className="bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all block">
 ...
 <Link href="/tools/dmarc-lookup" className="bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all block">
 ...
 <Link href="/tools/dmarc-generator" className="bg-white border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all block">
 ...
 <p className="text-gray-600 text-sm mb-2"><strong>How it works:</strong> Your mail server signs emails with a private key. Receivers verify using a public key in DNS at <code className="bg-gray-100 px-1 text-xs">selector._domainkey.domain.com</code>.</p>
 ...
 <li>Enter your sending domain (e.g., <code className="bg-gray-100 px-1 text-xs">yourdomain.com</code>)</li>
 ...
 <li>Confirm the record ends with <code className="bg-gray-100 px-1 text-xs">-all</code> (hard fail), not <code className="bg-gray-100 px-1 text-xs">~all</code> (soft fail)</li>
 </ol>
 </div>
 ...
 <div className="bg-white border border-blue-200 p-6 mb-8 shadow-sm">
 ...
 <p className="text-gray-600 text-sm">
 Many domains still have no DMARC record at all. Without DMARC, ISPs have no policy instructions for handling authentication failures, and you receive no reporting data about who is sending email using your domain. Even a <code className="bg-gray-100 px-1 text-xs">p=none</code> policy with reporting is infinitely better than no DMARC record. <Link href="/blog/free-dmarc-lookup-generator-tool" className="text-blue-600 hover:underline">Learn how to set up DMARC &rarr;</Link>
 </p>
 </div>
 ...
 <Link href="/product/email-infrastructure-health-check" className="bg-blue-50 p-6 border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
 ...
 <Link href="/product/email-infrastructure-protection" className="bg-blue-50 p-6 border border-blue-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
