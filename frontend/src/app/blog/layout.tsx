...
function TableOfContents({ offsetY }: { offsetY: number }) {
 ...
 >
 <div className="bg-white/70 backdrop-blur-md border border-white/30 p-4 shadow-lg shadow-gray-200/30">
...
export default function BlogLayout({ children }: { children: React.ReactNode }) {
 ...
 {blogPageSeo[pathname]?.tldr && <TldrBlock text={blogPageSeo[pathname]!.tldr!} />}
 {children}
 </div>
 </main>
