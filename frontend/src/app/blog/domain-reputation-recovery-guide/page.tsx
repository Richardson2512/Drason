...
<div className="prose prose-lg max-w-none">
 ...
 <Link href="/blog/domain-burned-recovery-prevention" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
 ...
 <Link href="/blog/how-to-check-domain-reputation-cold-email" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
