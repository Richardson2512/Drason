...
export default function InfrastructureAssessmentPost() {
 ...
 {/* Key Takeaways */}
 <div className="not-prose bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 p-6 mb-12 shadow-sm">
 ...
 <div className="bg-blue-50 border border-blue-200 p-8 mt-12 text-center">
