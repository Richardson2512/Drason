...
export const alt = 'Best Instantly Alternatives for Cold Email Teams in 2026 — Superkabe';
            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ fontSize: 26, color: '#4B5563', lineHeight: 1.4, maxWidth: 1000 }}>
                        7 ranked tools for teams that have outgrown Instantly&apos;s per-active-lead pricing or need automated auto-pause and ESP-aware routing.
                    </div>
                </div>
