...
export default function CatchAllDomainsColdOutreachArticle() {
 ...
 <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(blogPostingSchema) }} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.superkabe.com"}, {"@type": "ListItem", "position": 2, "name": "Blog", "item": "https://www.superkabe.com/blog"}, {"@type": "ListItem", "position": 3, "name": "Catch-all domains: the hidden risk destroying your cold email deliverability", "item": "https://www.superkabe.com/blog/catch-all-domains-cold-outreach"}]}) }} />
...
<div className="prose prose-lg max-w-none">
 ...
 <Link href="/docs/help/email-validation" className="bg-white p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
