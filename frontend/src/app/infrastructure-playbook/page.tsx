...
export const metadata: Metadata = {
 ...
 openGraph: {
 title: 'The Outbound Email Infrastructure Playbook – Superkabe',
 description: 'How to run high-volume outbound with AI sequences, multi-mailbox scaling, and an auto-healing protection layer underneath.',
...
export default function InfrastructurePlaybookPage() {
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-6 mt-16">2. How Active Deliverability Protection Works</h2>

 <h3 className="text-2xl font-bold text-gray-800 mb-4 mt-8">What is the Protection Layer?</h3>
 <p className="mb-6 leading-relaxed">
 The protection layer is the deliverability-safety system built into Superkabe. Whether you&apos;re sending natively from Superkabe (Google Workspace, Microsoft 365, or SMTP) or connecting Smartlead / Instantly / EmailBison in Protection Mode, the layer continuously watches every send, every bounce, and every reply in real time. Unlike traditional passive dashboards that only inform you a domain has burned <em>after</em> damage is permanent, the layer structurally intercepts traffic before compounding damage occurs.
 </p>
 ...
 <Link href="/product/lead-control-plane" className="block bg-white p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group hover:scale-[1.02]">
 ...
 <Link href="/product/esp-aware-routing" className="block bg-white p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group hover:scale-[1.02]">
 ...
 <Link href="/product/domain-burnout-prevention-tool" className="block bg-white p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group hover:scale-[1.02]">
 ...
 <Link href="/product/automated-domain-healing" className="block bg-white p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group hover:scale-[1.02]">
 ...
 <Link href="/blog/email-deliverability-guide" className="block bg-white p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group hover:scale-[1.02]">
 ...
 <Link href="/docs/help/validation-credits" className="block bg-white p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group hover:scale-[1.02]">
