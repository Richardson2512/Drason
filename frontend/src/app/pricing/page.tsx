...
export default function PricingPage() {
 ...
 "description": "AI-powered cold email platform with built-in deliverability and LinkedIn signal-based automated outreach. AI sequences, multi-mailbox sending, validation, ESP-aware routing, and the full healing pipeline in one platform.",
 ...
 "description": "Transparent pricing for Superkabe - the AI-powered cold email platform with built-in deliverability and LinkedIn signal-based automated outreach. AI sequences, multi-mailbox sending, email validation, and the full healing pipeline in every plan. From $19/month, with a 14-day free trial.",
