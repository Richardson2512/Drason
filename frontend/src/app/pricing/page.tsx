...
export default function PricingPage() {
    return (
        <div className="relative bg-[#F5F8FF] text-[#1E1E2F] min-h-screen font-sans">
            ...
            {/* Hero Section */}
            <div className="relative pt-48 pb-24 text-center px-6">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    ...
                    <p className="text-2xl text-gray-500 mb-4 max-w-3xl mx-auto">
                    ...
                    <div className="mt-8 space-y-2">
                        <p className="text-xl font-semibold text-gray-900">We don't optimize volume.</p>
                        <p className="text-xl font-semibold text-blue-600">We prevent irreversible damage.</p>
                    </div>
                </div>
            </div>
            ...
            {/* ROI Framing */}
            <div className="max-w-4xl mx-auto px-6 py-16 mb-24 border-t border-gray-200">
                <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">
                    ROI Framing
                </h2>
...
function PricingCard({ tier, description, price, period, features, bestFor, ctaText = "Get started", featured = false }: PricingCardProps) {
    return (
        <div className={`relative bg-white rounded-3xl p-8 border ${featured ? 'border-blue-500 shadow-2xl shadow-blue-500/10 scale-105 z-10' : 'border-gray-100 shadow-lg shadow-gray-200/50'} hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300 flex flex-col h-full`}>
            {featured && (
