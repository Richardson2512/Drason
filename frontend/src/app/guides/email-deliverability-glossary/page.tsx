...
export default function EmailDeliverabilityGlossary() {
 ...
 { letter: 'D', term: 'Deliverability Protection (Active)', definition: 'A continuous protection system that watches every send, bounce, and reply in real time - validating leads before send, auto-pausing mailboxes when bounce thresholds are breached, rerouting traffic to healthier senders, and running graduated recovery pipelines. Superkabe ships this protection as part of its AI cold email platform - every send through your connected Gmail, Microsoft 365, or SMTP mailbox runs through the same safety layer.', relevance: 'Most cold email stacks rely on dashboards that report damage after the fact. Active protection intervenes before bounce spikes compound into permanent reputation loss.', link: '/product/email-validation-infrastructure-protection', linkText: 'How Superkabe\u2019s protection works' },
 ...
 { letter: 'S', term: 'Smartlead', definition: 'A cold email sending platform that manages campaigns, mailbox rotation, and sequencing. Supports multiple mailboxes per campaign and offers API access for programmatic lead management and campaign control.', relevance: 'Smartlead is a popular sending platform for cold outreach teams. It does not include built-in validation or infrastructure protection. Superkabe offers a one-time import to migrate Smartlead campaigns, sequences, and leads across.', link: '/dashboard/migration/from-smartlead', linkText: 'Import from Smartlead' },
 ...
 {letters.map(letter => (
 <a key={letter} href={`#letter-${letter.toLowerCase()}`} className="inline-block w-10 h-10 bg-white border border-gray-200 text-center leading-10 font-bold text-blue-600 hover:bg-blue-50 hover:border-blue-300 transition-colors text-sm">
 {letter}
 </a>
 ))}
 </div>
 ...
 <div key={item.term} id={`term-${item.term.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`} className="bg-white border border-gray-100 p-6 shadow-sm">
 ...
 <p className="text-gray-600 text-sm leading-relaxed">A hard bounce is permanent - the address does not exist or the server has permanently rejected your message. A soft bounce is temporary - full mailbox, server down, or message too large. Soft bounces are retried. Hard bounces should never be retried and the address should be removed immediately.</p>
 </div>
 <div className="bg-white border border-gray-100 p-6 shadow-sm">
 ...
 <p className="text-blue-100 mb-6 max-w-xl mx-auto">Superkabe monitors every metric in this glossary in real-time. Validation, bounce tracking, health classification, auto-pause, and healing - all automated.</p>
 ...
 <Link href="/guides/email-validation-cold-outreach" className="inline-block border-2 border-white/30 text-white font-semibold px-8 py-3 hover:bg-white/10 transition-colors">
 ...
 <Link href="/guides/outbound-email-infrastructure-stack" className="block p-4 bg-white border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all text-sm text-gray-700 hover:text-blue-700">The Modern Outbound Infrastructure Stack &rarr;</Link>
 <Link href="/blog/spf-dkim-dmarc-explained" className="block p-4 bg-white border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all text-sm text-gray-700 hover:text-blue-700">SPF, DKIM, and DMARC Explained &rarr;</Link>
 <Link href="/blog/bounce-rate-deliverability" className="block p-4 bg-white border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all text-sm text-gray-700 hover:text-blue-700">Bounce Rate and Deliverability &rarr;</Link>
 <Link href="/blog/email-reputation-lifecycle" className="block p-4 bg-white border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all text-sm text-gray-700 hover:text-blue-700">Email Reputation Lifecycle &rarr;</Link>
 <Link href="/blog/domain-warming-methodology" className="block p-4 bg-white border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all text-sm text-gray-700 hover:text-blue-700">Domain Warming Methodology &rarr;</Link>
 </div>
 </div>
 </div>
 </div>
